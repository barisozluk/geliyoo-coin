...
import client_key_image from '../../assets/images/wallet-platform/client-key.svg'
import backup_key_image from '../../assets/images/wallet-platform/backup-key.svg'
import cold_storage_image from '../../assets/images/wallet-platform/cold-storage.svg'
import key_image from '../../assets/images/wallet-platform/key.svg'
                            ...
                            <div className="flex-shrink-1 pr4">
                                <div className="mb4 relative">
                                 ...
                                 <div className="relative">
                                    <img src={backup_key_image} className="l-marketingIcon l-marketingIcon--clear mb2" />
