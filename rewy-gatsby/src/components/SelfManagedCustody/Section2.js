...
import offline_image from '../../assets/images/self-managed-custody/offline.svg'
import technology_image from '../../assets/images/self-managed-custody/technology.svg'
import procedures_image from '../../assets/images/self-managed-custody/procedures.svg'
                        ...
                        <div className="cf nmh4 flex-l">
                            <div className="flex flex-column items-center justify-center mb0-l measure-wide2 center">
                                ...
                                <div className="cf nmh2 w-100 flex items-stretch">
                                    ...
                                    <div className="fl w-50 bl b--border pa4">
                                        <img className="l-marketingIcon mb3-l" src={storage_image} />
                                        <div className="f5-l fw6 lh-title mb2">
                                            Safe storage
                                        </div>
                                    </div>
